const messages = {
  form: {
    error: {
      select_product_and_quantity: "Selecionar o produto e a quantidade.",
      add_at_least_one_product: "Adicionar pelo menos um produto.",
      select_employee_and_client: "Selecionar vendedor e cliente.",
